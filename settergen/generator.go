...
func (g *SetterGenerator) generateDefinition(targets []*targetInfo) (*gg.Generator, error) {
	...
	gen.SetHeader("Code generated by %s. DO NOT EDIT.\n", "setterGen")
		...
		for _, patchMode := range patchModes {
			...
			case "v2":
				...
				if t.mapperMethod != nil {
					_, code, err := automap.Generate2WithOptions((*t.mapperMethod)[0], "ToPatch", automap.WithFileContext((*t.mapperMethod)[1]))
					if err != nil {
