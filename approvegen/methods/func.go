...
// 例子:
// func:name="approveFor"; module="ABC"; event="EVENT"; nest=true; args=["name string", "codes github.com/donutnomad/gogen/internal/utils#EString"]
...
// 支持格式: args=["name string", "codes github.com/donutnomad/gogen/internal/utils#EString"]
...
// 支持格式: "name string" 或 "codes github.com/donutnomad/gogen/internal/utils#EString"
func parseArgElement(element string) *FuncMethodArg {
	...
	if strings.Contains(typeWithImport, "#") {
		// 格式: github.com/donutnomad/gogen/internal/utils#EString
